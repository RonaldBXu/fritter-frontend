...
import {creditRouter} from '../server/credit/router';
import {scheduledFreetRouter} from '../server/scheduledFreet/router';
import {cooldownRouter} from '../server/cooldown/router';
